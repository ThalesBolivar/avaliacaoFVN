-- ============================================================================
-- SEED: Perguntas da Ficha Médio (ANEXO II - LC 197/2019 - PCCV SAAE)
-- ----------------------------------------------------------------------------
...
--
-- Como rodar:
--   mysql -u USUARIO -p NOME_DO_BANCO < médio.sql
-- ============================================================================
...
VALUES
    (@municipio_id,
     'Avaliação de Desempenho - Nível Médio',
     'Ficha Médio (ANEXO II) - LC 197/2019 - PCCV SAAE',
...
SET @p := LAST_INSERT_ID();
INSERT INTO opcoes_pergunta_avaliacao (pergunta_avaliacao_id, letra_opcao, texto_opcao, pontuacao, criado_em) VALUES
(@p,'A','O servidor desempenha suas atividades com desenvoltura e de forma eficaz. Sempre aplica recursos com eficácia teórica e prática inclusive em atividades mais complexas.',NULL,NOW()),
(@p,'B','O servidor desempenha suas atividades sem desenvoltura, necessitando do auxílio de colegas. Aplica frequentemente de forma adequada teoria e prática.',NULL,NOW()),
(@p,'C','O servidor demonstra conhecer, mas não domina as regras técnicas inerentes a sua função. Tem dificuldades para executar atividades mais complexas.',NULL,NOW()),
(@p,'D','O servidor demonstra não conhecer as regras técnicas inerentes à sua função. Emprega de forma inadequada recursos teóricos e práticos.',NULL,NOW());
...
-- PERGUNTA 11 — ÉTICA NO SERVIÇO PÚBLICO (categoria ordem 7)
INSERT INTO perguntas_avaliacao
    (modelo_avaliacao_id, categoria_id, criterio, numero_pergunta, texto_pergunta,
     tipo_resposta, peso, obrigatoria, ativa, criado_em)
VALUES
...
-- PERGUNTA 12 — EQUILIBRIO EMOCIONAL (categoria ordem 8)
INSERT INTO perguntas_avaliacao
    (modelo_avaliacao_id, categoria_id, criterio, numero_pergunta, texto_pergunta,
     tipo_resposta, peso, obrigatoria, ativa, criado_em)
VALUES
...
-- PERGUNTA 13 — DEDICAÇÃO (categoria ordem 9)
INSERT INTO perguntas_avaliacao
    (modelo_avaliacao_id, categoria_id, criterio, numero_pergunta, texto_pergunta,
     tipo_resposta, peso, obrigatoria, ativa, criado_em)
VALUES
...
-- PERGUNTA 14 — SOCIABILIDADE E COOPERAÇÃO (categoria ordem 10)
INSERT INTO perguntas_avaliacao
    (modelo_avaliacao_id, categoria_id, criterio, numero_pergunta, texto_pergunta,
     tipo_resposta, peso, obrigatoria, ativa, criado_em)
VALUES
...
-- PERGUNTA 19 — TRABALHO EM EQUIPE (categoria ordem 12)
INSERT INTO perguntas_avaliacao
    (modelo_avaliacao_id, categoria_id, criterio, numero_pergunta, texto_pergunta,
     tipo_resposta, peso, obrigatoria, ativa, criado_em)
VALUES
...
--   SELECT COUNT(*) FROM perguntas_avaliacao WHERE modelo_avaliacao_id=@modelo_id; -- esperado: 19
--   SELECT COUNT(*) FROM opcoes_pergunta_avaliacao o JOIN perguntas_avaliacao p ON p.id=o.pergunta_avaliacao_id WHERE p.modelo_avaliacao_id=@modelo_id; -- esperado: 76
